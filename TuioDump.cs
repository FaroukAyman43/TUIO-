...
using TUIO;
	...
	public class TuioDump : TuioListener
	{
		...
		public void updateTuioObject(TuioObject tobj) {
			Console.WriteLine("55set obj "+tobj.SymbolID+" "+tobj.SessionID+" "+tobj.X+" "+tobj.Y+" "+tobj.Angle+" "+tobj.MotionSpeed+" "+tobj.RotationSpeed+" "+tobj.MotionAccel+" "+tobj.RotationAccel);
		}
